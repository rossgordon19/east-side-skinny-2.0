...
const Hero = () => {
  return (
    <div name="home" className="relative h-screen">
      ...
      <div className="relative z-10 flex flex-col md:flex-row h-full px-4 sm:px-6 lg:px-8 items-center justify-center">
        {/* img container */}
        <div className="flex justify-center items-center md:w-1/2 h-full">
          <img
            src={svFront}
            alt="SV Front"
            className="object-cover object-center h-64 w-64 lg:h-96 lg:w-96 scale-125 lg:scale-150 sm:mb-8 md:mb-0"
          />
        </div>
        <div className="flex flex-col items-center justify-center md:w-1/2 h-full">
          <a
            ...
            className="sm:hidden sm:translate-y-150"
          >
            <button className="bg-[#f5f5f7] text-[#0a0908] font-bold text-2xl py-6 px-16 rounded-lg focus:outline-none focus:shadow-outline">
              Listen Now
            </button>
          </a>
          <a
